...
论文地址 📝：[SRAG-MAV for Fine-Grained Chinese Hate Speech Recognition](https://arxiv.org/abs/2507.18580v1)

本项目所使用方法在 [CCL25-Eval 任务10：细粒度中文仇恨识别评测](https://tianchi.aliyun.com/competition/entrance/532298) 复赛中获得第二名的成绩，包含结果复现、技术报告及相关代码。  
