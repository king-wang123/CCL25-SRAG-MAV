...
- [技术报告](#技术报告)
  - [问题转化](#问题转化)
  - [提示词设置](#提示词设置)
  - [自检索增强生成 (Self-Retrieval Augmented Generation, SRAG)](#自检索增强生成-self-retrieval-augmented-generation-srag)
  - [多轮累积投票策略 (Multi-round Accumulative Voting, MAV)](#多轮累积投票策略-multi-round-accumulative-voting-mav)
- [实验结果与分析](#实验结果与分析)
  - [实验结果](#实验结果)
  - [结果分析](#结果分析)
- [补充实验](#补充实验)
